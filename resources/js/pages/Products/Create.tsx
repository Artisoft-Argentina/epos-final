                                    ...
                                    <FormField label="SKU" htmlFor="sku" error={errors.sku} hint={autoSku ? 'Se generará automáticamente al guardar.' : 'Código interno único del producto.'}>
                                        <div className="flex items-center gap-3">
                                            <div className="flex items-center gap-2 shrink-0">
                                                ...
                                                <label htmlFor="auto-sku" className="text-sm text-muted-foreground cursor-pointer select-none">Automático</label>
                                            </div>
                                            <Input
                                                id="sku"
                                                value={data.sku}
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <Card className="gap-0 py-0">
                                ...
                                <CardContent className="px-6 py-5 flex flex-col gap-4">
                                    <label htmlFor="images" className="flex flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed border-border bg-muted/30 p-6 text-center cursor-pointer hover:bg-muted/50 transition-colors">
                                        ...
                                        <div className="grid grid-cols-3 gap-2">
                                            {previews.map((src, i) => (
                                                <div key={i} className="relative group aspect-square rounded-md overflow-hidden border border-border">
                                                    ...
                                                    {i === 0 && (
                                                        <span className="absolute top-1 left-1 text-[10px] font-semibold bg-primary text-primary-foreground px-1.5 py-0.5 rounded">Principal</span>
                                                    )}
