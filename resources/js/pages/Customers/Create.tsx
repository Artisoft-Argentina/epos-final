...
interface Props { states: State[]; cities: City[]; }
...
export default function Create({ states, cities }: Props) {
    ...
    useEffect(() => {
        if (data.state_id) {
            setFilteredCities(cities.filter((c) => c.state_id.toString() === data.state_id));
        } else {
            setFilteredCities([]);
        }
        setData('city_id', '');
            ...
            <div className="flex flex-col gap-6 p-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <h1 className="text-2xl font-bold tracking-tight text-foreground">Nuevo Cliente</h1>
                        <p className="text-sm text-muted-foreground mt-0.5">Completá los datos para registrar un nuevo cliente.</p>
                    </div>
                                ...
                                <CardContent className="px-6 py-5 grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <FormField label="Nombre / Razón Social" htmlFor="business_name" error={errors.business_name} required className="md:col-span-2">
                                        <Input
                                            ...
                                            placeholder={data.person_type === 'juridica' ? 'Ej. Empresa S.A.' : 'Ej. Juan Pérez'}
                                ...
                                <CardContent className="px-6 py-5 grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <FormField label="Provincia" error={errors.state_id}>
                                        <Combobox
                                            ...
                                            value={data.state_id}
                                            onValueChange={(v) => setData('state_id', v)}
